...
# input feature and target names
X_names=['x','y','R','G','B','R/G','B/G','BRIGHTNESS']
# Y_names=['<50% diameter narrowing','>50% diameter narrowing']
...
tree.plot_tree(clf,feature_names=X_names)
#
print("decision tree result="+ clf.score(X_Test,Y_Test).astype('str'))
#
